...
if (isset($_POST['conexion'])) {
    ...
    mysqli_query($conexion, "DELETE  from companies where COMPANY_ID ='$COMPANY_ID'")
...
<head>
    ...
    <title>ESSystem-DelUser-Empresas</title>
                        ...
                        <div class="col-12">
                            <form action="deluser_empresas.php" method="post" class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Delete Usuario Companies</h3>
                                </div>
                                <div class="card-body">
                                        ...
                                        <fieldset class="form-fieldset">
                                            <div class="form-group">
                                                ...
                                                <div class="container-fluid" >  
                                                    <div class="row">
                                                     <div class="col-sm-6" >
                                                            <div class="btn-group btn-group-justified" role="group" aria-label="edicion-e">
                                                                <form action="deluser_empresas.php">
