          ...
          <div class="row align-items-center">
            <div class="col-lg-3 ml-auto">
              ...
              <form action="buscador.php" method="post" class="input-icon my-3 my-lg-0">
                <input type="text" class="form-control header-search" placeholder="Search&hellip;" tabindex="1" id="search">
        ...
        <div class="my-3 my-md-5">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-3">
                <div class="card">
                   <h3 class="card-title">Sistema de Gestión de Usuarios</h3>
                 </div>
                 <div class="card-body">
           ...
           <div class="col-md-9 ml-auto">
                  <form action="buscador.php" method="post" class="input-icon my6 my-lg-4">
                    <input type="text" name="search" class="form-control header-search" placeholder="Search&hellip;" tabindex="1" id="search">
                    <div class="input-icon-addon">
                      <i class="fe fe-search"></i>
                    </div>
                  </form>
             ...
             <div class="col-md-9 ml-auto">
                ...
                <form action="index_02.php" method="post" class="card">
                  <div class="container-fluid">
                      <div class="col-md-12">
                      <div class="form-row">
