...
$consulta=  mysqli_query($conexion, "SELECT * from companies")
...
<head>
  ...
  <title>ESSystem-Reg-Empresas</title>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-12">
                  <form action="deluser_empresas.php" method="post" class="card">
                          ...
                          <fieldset class="form-fieldset">
                            <div class="form-group">
                             ...
                             <div class="content">
                              ...
                              echo '<th>COMPANY_PHONE</th>';
                              echo '<th>COMPANY_MOBILE</th>';
                              echo '<th>LOCALITY</th>';
                              ...
                              while ($extraido = mysqli_fetch_array($consulta))
                              {
                                echo '<tr>';
                                echo '<td></td>';
                                echo '<td>'.$extraido['COMPANY_ID'].'</td>';
                                echo '<td>'.$extraido['COMPANY_NAME'].'</td>';
                                echo '<td>'.$extraido['COMPANY_EMAIL'].'</td>';
                                echo '<td>'.$extraido['COMPANY_PHONE'].'</td>';
                                echo '<td>'.$extraido['COMPANY_MOBILE'].'</td>';
                                echo '<td>'.$extraido['LOCALITY'].'</td>';
                                ...
                                echo '<a href="profile.php" class="btn btn-secondary btn-sm">Ver perfil</a></td>';
                                echo '<td>';
                                echo  '<a class="btn btn-secondary btn-sm " href="deluser.php" data-toggle="modal" data-target="#exampleModalScrollable">Eliminar</a>';
                                
                                echo'</td>';
                                echo'<td>';
                                echo'<a class="icon" href="edituser.php">';
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="form-row">
                          ...
                          <div class="card">
                            <div class="card-header">
                              <h3 class="card-title">Modulo de creacion de usuarios</h3>
                              <div class="card-options">
                                <a href="newuser_empresas.php" class="btn btn-primary btn-sm"> Crear Usuario</a>
                                <a href="index_02.php" class="btn btn-secondary btn-sm ml-2">Cancelar</a>
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Eliminar Empresas</h5>
                                                    ...
                                                    <div class="row">
                                                       <div class="col-sm-12" >
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <form action="deluser_empresas.php" method="POST">
