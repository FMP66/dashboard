...
if (isset($_POST)) {
    ...
    mysqli_query($conexion, "DELETE  from users_login where USER_ID ='$USER_ID'")
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg order-lg-first">
                            <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                                <li class="nav-item">
                                    <a href="./index_03.php" class="nav-link active"><i class="fe fe-home"></i> Home</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="row">
                                        <fieldset class="form-fieldset">
                                            <div class="form-group">
                                                ...
                                                $consulta=  mysqli_query($conexion, "SELECT * from users_login LIMIT 20 OFFSET 41")
                                                ...
                                                <div class="container-fluid" class="form-control">  
                                                    <div class="row">
                                                       <div class="col-md-6" >
                                                        <div class="btn-group btn-group-justified" role="group" aria-label="edicion">
                                                            ...
                                                            <div class="col-md-6">
                                                                <form action="deluser_logi.php" method="POST">
