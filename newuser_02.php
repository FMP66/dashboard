...
if (isset($_POST['conexion'])) {
  ...
  $insertar = "INSERT INTO users VALUES('$FIRST_NAME', '$LAST_NAME', '$EMAIL', '$PHONE', '$MOBILE', '$ADDRESS', '$COUNTRY', '$CITY', '$DATE')";
      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5">
          ...
          <div class="container">
            <div class="row">
              <div class="col-12">
                <form action="newuser_02.php" method="post" class="card">
                  ...
                  <div class="card-body">
                   ...
                   <div class="col-5">
                    <div class="form-group">
                        <div class="form-label">Inserte una imagen</div>
