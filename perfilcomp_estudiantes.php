...
<head>
  ...
  <title>ESSystem-Perfilcomp.</title>
                        ...
                        <fieldset class="form-fieldset">
                          <div class="form-group">
                            <table class="table table-stripe table-hover">
                              <tr>
                                <tr><th ROWSPAN=9>
                                  <img src="imagenes\cara niño.jpg" width="350" height="300"></</th></tr>

                                  <tr><h6><th>ID</th>
                                    <td>ID001-ES</td></h6></tr>
                                            ...
                                            <table class="table table-stripe table-hover">
                                              <tr>
                                                <tr><th>Descripción</th>
                                                  <td>Varon 12 años  alt.1,55 mts.</td></tr>
                                                  ...
                                                  <tr><th>Telefono casa</th>
                                                        ...
                                                        <tr><th>Telefono Escuela</th>
                                                          ...
                                                          <div class="col-md-12">
                                                            <ul class="nav nav-pills nav-">
                                                              <a href="perfilcomp_estudiantes.php" class="list-group-item"><h1><i class="fas fa-user-alt"></i></h1>  Perfil personal</a>                      
                                                              <a href="perfil_acad.php" class="list-group-item"><h1><i class="fas fa-user-graduate"></i></h1>   Perfil Academico</a>
                                                              <a href="familia.php" class="list-group-item"><h1><i class="fas fa-users"></i></h1>   Familia</a>
                                                            </ul>
                                                          </div></div><BR>
                                                        </div>
                                                      </div>  
                                                    ...
                                                    <div class="col-md-12">
                                                      <div class="container">
                                                        <div class="panel-footer">SYSTEM-WATSON@2019</div>
                                                      </div>
                                                    </div>
                                                      <div class="footer">
        <div class="container">
