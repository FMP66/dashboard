...
$sql= mysqli_query($conexion, "SELECT * FROM users INNER JOIN users WHERE USER_ID = $USER_ID ");
        ...
        <div class="header collapse d-lg-flex p-0" id="headerMenuCollapse">
          <div class="container">
            ...
            <div class="container">
              <div class="row">
                <div class="col-12">
                  <form action="edituser.php" method="post" class="card">
                    <div class="card-header">
                      <h3 class="card-title">Actualizacion de Datos</h3>
                    </div>
                  <div class="form_register form-control">
                        <hr>
                        ...
                        <form action="edituser.php" method="POST">
                            ...
                            <input type="text" class="form-control" name="FIRST_NAME" id="FIRST_NAME" placeholder="FIRST_NAME" value="<?php echo $FIRST_NAME; ?>">
                            
                            <label for="LAST_NAME">LAST NAME</label>
                            <input type="text" class="form-control" name="LAST_NAME" id="LAST_NAME" placeholder="LAST_NAME" value="<?php echo $LAST_NAME; ?>">
