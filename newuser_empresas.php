...
$insertar = "INSERT INTO companies VALUES('$COMPANY_ID', '$COMPANY_NAME', '$COMPANY_EMAIL', '$COMPANY_PHONE', '$COMPANY_MOBILE', '$LOCALITY', '$PROVINCE', '$COUNTRY', '$DATE')";
...
<head>
	...
	<title>ESSystem-Newuser-Companies</title>
							...
							<div class="row">
								<div class="col-12">
										...
										<div class="card-header">
											<h3 class="card-title">New user companies</h3>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-md-6">
												<fieldset class="form-fieldset">
														...
														<form class="form-control" action="newuser_empresas.php" method="POST" >
															<div class="form-group">
																<label class="form-label">COMPANY_NAME<span class="form-required" id="COMPANY_NAME" >*</span></label>
																	<input type="text" name="COMPANY_NAME" class="form-control" placeholder="COMPANY_NAME" aria-describedby="COMPANY_NAME">
																</div>
															

															<div class="form-group">
																
																	<label class="form-label">COMPANY_EMAIL<span class="form-required" id="COMPANY_EMAIL" >*</span></label>
																	<input type="Email" name="COMPANY_EMAIL" class="form-control" placeholder="COMPANY_EMAIL" aria-describedby="COMPANY_EMAIL">
																</div>
															<div class="form-group">
																
																	<label class="form-label">COMPANY_PHONE<span class="form-required" id="COMPANY_PHONE" >*</span></label>
																	<input type="text" name="COMPANY_PHONE" class="form-control" placeholder="COMPANY_PHONE" aria-describedby="COMPANY_PHONE">
																</div>
															
																<div class="form-group">
																	
																<label class="form-label">COMPANY_MOBILE<span class="form-required" id="COMPANY_MOBILE" >*</span></label>
																<input type="text" name="COMPANY_MOBILE" class="form-control" placeholder="COMPANY_MOBILE" aria-describedby="COMPANY_MOBILE">
															</div>
														...
														</form></fieldset></div></div></div></form></div></div></div></div></div></div>
