...
<head>
  ...
  <title>English School System</title>
                                                        ...
                                                        <tr><th>Telefono Escuela</th>
                                                          ...
                                                          <div class="col-md-12">
                                                            <ul class="nav nav-pills nav-">
                                                              <a href="perfil_completo.html" class="list-group-item"><h1><i class="fas fa-user-alt"></i></h1>  Perfil personal</a>                      
                                                              <a href="perfil_acad.html" class="list-group-item"><h1><i class="fas fa-user-graduate"></i></h1>   Perfil Academico</a>
                                                              <a href="familia.html" class="list-group-item"><h1><i class="fas fa-users"></i></h1>   Familia</a>
                                                            </ul>
                                                          </div></div><BR>
