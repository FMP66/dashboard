...
<head>
	...
	<title>ESSystem-Reg-Escuelas</title>
								...
								<div class="col-12">
									<form action="#" method="post" class="card">
										<div class="card-header">
											<h3 class="card-title">Registro de Escuelas</h3>
										</div>
										<div class="card-body">
											<div class="row">
														...
														<div class="form-group">
															...
															<table class="table table-stripe table-hover table-sm">
																	...
																	while ($extraido = mysqli_fetch_array($consulta))
																	{
																		...
																		echo '<td>'.$extraido ['SCHOOL_EMAIL'].'</td>';
																		...
																		echo  '<a class="btn btn-secondary btn-sm " href="deluser_escuelas.php">Eliminar</a>';
																		
																		echo'</td>';
																		echo'<td>';
																		echo'<a class="icon" href="edituser.html">';
									                          ...
									                          <div class="card">
									                            <div class="card-header">
									                              ...
									                              <div class="card-options">
									                                <a href="newuser_escuelas.php" class="btn btn-primary btn-sm"> Crear Usuario</a>
