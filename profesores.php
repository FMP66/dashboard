...
mysqli_close($conexion);
       // echo "Datos ELiminado Exitosamente";
...
<head>
  ...
  <title>ESSystem-Profesores</title>
                              ...
                              <fieldset class="form-fieldset">
                                <div class="form-group">
                                  ...
                                  <table class="table table-stripe table-hover">
                                    <tr>
                                      <tr><th ROWSPAN=9>
                                        <img src="imagenes\profesor.jpg" width="250" height="300"></</th></tr>

                                        <tr><h6><th>ID</th>
                                          <td>ID001-P</td></h6></tr>

                                          <tr><th>Nombre</th>
                                            <td>Somhairle Watson</td></tr>

                                            <tr><th>Dirección</th>
                                             <td>Malaga, España 117</td></tr>


                                             <tr><th>Telefonos</th>
                                               <td>053-000 00000</td></tr>

                                               <tr><th>Email</th>                        
                                                <td>Somhairle Watson@gmail.com</td>
                                                <tr>
                                                  <th>Registrado</th></h6>
                                                  <td>Mayo 15, 2019</td></tr>
                                                </tr></tr>
                                              </table>
                                              ...
                                              <div class="panel panel-default">
                                                <div class="panel-body">
                                                  <table class="table table-stripe table-hover">
                                                    <tr>
                                                      <tr><th>Descrpcion perfil</th>
                                                        <td>Lic. en Educacion con Maestria en Pedagogia, 42 años  alt.1,80 mts.</td></tr>
                                                        <tr></tr><th>Dirección completa</th>
                                                        <td>Malaga, Ciudad Jardin, Av. de las Mercedes, 116.</td></tr>
                                                        <tr><th>Telefono casa</th>
                                                          <td>+53 000 00000</td></tr>
                                                          <tr><th>Escuela</th>
                                                            <td>Nuestra Señora de las Mercedes</td></tr>
                                                            <tr><th>Dirección de escuela</th>
                                                              <td>Malaga, Ciudad Jardin, Av. de las Mercedes, 116.</td></tr>
                                                              <tr><th>Telefono Escuela</th>
                                                                <td>+53 000 00000</td></tr>
                                                                <tr><th>Grado de Instrucción</th>
                                                                  <td>secundaria</td></tr>
                                                                  <tr><th>Cursa actualmente</th>
                                                                    <td>1er.año Educacion Basica</td></tr>
                                                                  </tr>
                                                                </table>
                                                            ...
                                                            <div class="panel-default">
                                                              <div class="panel-heading">
                                                                <h5 class="panel-title">Registros de Profesores</h5>
                                                              </div>
                                                               ...
                                                               <div class="Busqueda">
                                                                <div class="well">
                                                                 ...
                                                                 <div class="input-group input-group-sm">
                                                                  <span class="input-group-addon" id="sizing-addon3">Busqueda</span>
                                                                ...
                                                                <table class="table table-stripe table-hover">
                                                                  <tr>
                                                                    ...
                                                                    <tr>
                                                                     <td><img src="imagenes\profesor.jpg" width="35" height="52"></td>

                                                                     <th>ID001-P</th>
                                                                     <td>Somhairle Watson</td>
                                                                     <td>Malaga, España 117</td>
                                                                     <td>053-000 00000</td>
                                                                     <td>Somhairle Watson@gmail.com</td>
                                                                     <td>Mayo 14, 2019</td>
                                                                   </tr>
          ...
          <div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
              Copyright © 2019 <a href=".">English School System</a>. Theme by <a href="https://codecalm.net" target="_blank">English School System</a> All rights reserved.
                                                     ...
                                                     <script src="hcode.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
