        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-lg-3 ml-auto">
              ...
              <form action="index03.php" method="post" class="input-icon my-3 my-lg-0">
                <input type="search" class="form-control header-search" placeholder="Search&hellip;" tabindex="1" id="search" name="search">
            ...
            <div class="col-lg order-lg-first">
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                <li class="nav-item">
                  <a href="./index03.php" class="nav-link active"><i class="fe fe-home"></i> Home</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4">
              <div class="col col-login mx-auto">
                <form action="index03.php" method="post" class="form-control" name="newuser2">
          ...
          <div class="col-md-8 ml-auto">
                        ...
                        <div class="card-body">
                          <table class="table table-stripe table-hover table-sm" >
                            <div class="content">
                              ...
                              $consulta=  mysqli_query($conexion, "SELECT * from users_login LIMIT 20 OFFSET 20")
                              ...
                              while ($extraido = mysqli_fetch_array($consulta))
                              {
                                ...
                                echo  '<a class="btn btn-secondary btn-sm " href="deluser.php">Eliminar</a>';

                                echo'</td>';
                                echo'<td>';
                                echo'<a class="icon" href="edituser2.php" onclick="modificar">';
                              ...
                              ?>
                                ...
                                <nav aria-label="...">
                                  <ul class="pagination">
                                    ...
                                    <li class="page-item"><a class="page-link" href="index_03.php">1</a></li>
                                    ...
                                    <li class="page-item"><a class="page-link" href="index_03.php">3</a></li>
                                    <li class="page-item">
                      ...
                      <div class="container my-3"><
                        <div class="row">
                          <form action="index03.php" method="post" class="card">
                            <div class="card-header">
                              <h3>Modulo de edicion de usuarios</h3>
                            </div>
                            <div class="card-body">
                               <div class="container-fluid my-1">
                              <div class="col-md-6">
                                <a href="newuser.php" class="btn btn-primary btn-sm"> Crear Usuario</a>
                                <a href="index03.php" class="btn btn-secondary btn-sm ml-2">Cancelar</a>
                                <a href="index.php" class="btn btn-danger btn-sm ml-2">Salir</a>
                              </div>
                            </div>
                          </div>
                        </form>
                        ...
                        <div class="col-md-6 ml-auto">
                         <input type="search" id="search" name="search" class="form-control header-search" placeholder="Search&hellip;" tabindex="1" >
                         <div class="input-icon-addon">
                          <i class="fe fe-search"></i>
                        </div>
                      </div>
                        ...
                        <div class="content">
                          ...
                          $consulta=  mysqli_query($conexion, "SELECT * from users LIMIT 25 OFFSET 10")
                          or die("Error al TRAER LOS DATOS");
                          ...
                          while ($extraido = mysqli_fetch_array($consulta))
                          {
                            ...
                            echo'</td>';
                            echo'<td>';
                            echo'<a class="icon" href="index_03.php" onclick="modificar" data-toggle="modal" data-target="#modificar">';
                            echo'<i class="fe fe-edit"></i>';
                            echo'</a>';
                            echo'</td>';
                            echo '</tr>';
        ...
        ...  <div class="container">
                            <div class="row">
                              <div class="col-md-12 form-control">
                                <form action="index_03.php" method="post" id="modificar-form">
                                  <div class="form-group">
                        ...
                        <div class="modal-footer">
                          <button href="index_03.php" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                          <button href="index_03.php" name="modificar" type="submit" class="btn btn-primary" onclick="modificar">Save changes</button>
                        </div>
                      </div>
                    </div>
                  </div>
