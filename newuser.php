...
or die("error en la conexion a la base de datos");
	...
	$insertar = "INSERT INTO users VALUES('$USER_ID','$FIRST_NAME','$LAST_NAME','$EMAIL','$PHONE','$MOBILE','$ADDRESS','$COUNTRY','$CITY','$DATE')";
...
<body class="">
	<div class="page">
						...
						<div class="col-lg order-lg-first">
							<ul class="nav nav-tabs border-0 flex-column flex-lg-row">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-arrow">
										<a href="./maps.php" class="dropdown-item ">Administración</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<form action="index04.php" method="post" class=" form-control">
							...
							<div class="col-md-8">
								<fieldset class="form-fieldset">
									...
									<div class="form-group">
										<label class="form-label">First_name<span class="form-required">*</span></label>
										<input id="FIRST_NAME" name="FIRST_NAME" type="text" class="form-control" />
									</div>
									<div class="form-group">
										<label class="form-label">Last_name<span class="form-required"  >*</span></label>
									...
									<button type="submit" class="btn btn-success" href="index04.php">Cancelar</button>
								</fieldset>
							</div>
						</div>
					</form>
