<?php 
      ...
      $consulta=  mysqli_query($conexion, "SELECT * from users_teachers")
...
<head>
  ...
  <title>ESSystem-Reg-Profesores</title>
      ...
      <div class="header collapse d-lg-flex p-0" id="headerMenuCollapse">
        <div class="container">
          ...
          <div class="container">
            <div class="row">
              <div class="col-12">
                <form action="deluser_profesores.php" method="post" class="card">
                     ...
                     <div class="col-md-12">
                      <fieldset class="form-fieldset">
                        <div class="form-group">
                          <table class="table table-stripe table-hover table-sm"><br>
                            ...
                            while ($extraido = mysqli_fetch_array($consulta))
                            {
                              ...
                              echo '<td class="text-right">';
                                    ...
                                    echo  '<a class="btn btn-secondary btn-sm " href="deluser_profesores.php">Eliminar</a>';
                          ...
                          <div class="card">
                            <div class="card-header">
                              ...
                              <div class="card-options">
                                <a href="newuser_profesores.php" class="btn btn-primary btn-sm"> Crear Usuario</a>
