...
if (isset($_POST['conexion'])) {
    ...
    mysqli_query($conexion, "DELETE * from schools where SHOOL_ID ='$SCHOOL_ID'")
...
<head>
    ...
    <title>ESSystem-DelUser-Escuelas</title>
...
<body class="">
    <div class="page">
        <div class="page-main">
            ...
            <div class="my-3 my-md-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <form action="deluser_escuelas" method="post" class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Delete Usuario Escuelas</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <fieldset class="form-fieldset">
                                            <div class="form-group">
                                                ...
                                                $consulta=  mysqli_query($conexion, "SELECT * from schools")
                                                or die("Error al TRAER LOS DATOS");

                                                echo  '<table class="table table-stripe table-hover table-sm" id="tabla">';
                                                
                                                echo '<tr>';
                                                echo'<th>SCHOOL_ID</th>';
                                                echo '<th>SCHOOL_NAME</th>';
                                                echo '<th>SCHOOL_PHONE</th>';
                                                echo '<th>SCHOOL_MOBILE</th>';
                                                echo '<th>LOCALITY</th>';
                                                echo '<th>PROVINCE</th>';
                                                echo '<th>COUNTRY</th>';
                                                echo '<th>DATE</th>';
                                                ...
                                                if (isset($_POST)) {
                                                    ...
                                                    {
                                                        echo '<tr>';
                                                        echo '<td>'.$extraido['SCHOOL_ID'].'</td>';
                                                        echo '<td>'.$extraido['SCHOOL_NAME'].'</td>';
                                                        echo '<td>'.$extraido['SCHOOL_PHONE'].'</td>';
                                                        echo '<td>'.$extraido['SCHOOL_MOBILE'].'</td>';
                                                        echo '<td>'.$extraido['LOCALITY'].'</td>';
                                                        echo '<td>'.$extraido['PROVINCE'].'</td>';
                                                    ...
                                                    <div class="row">
                                                       <div class="col-sm-12" >
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <form action="deluser_escuelas.php" method="POST">
                                                                    <div class="input-group input-group-sm">
                                                                        <span class="input-group-addon" id="sizing-addon1">SCHOOL_ID:||</span>
                                                                        <input type="text" name="SCHOOL_ID" class="form-control" placeholder="Introduzca el usuario" aria-describedby="sizing-addon1">
                                                                    </div><br>
        ...
        </div></form></div></div></div></div></div></div></body>
